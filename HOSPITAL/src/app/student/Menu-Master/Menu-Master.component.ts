  ...
  constructor(private router: Router,
   ...
   ngOnInit(): void {
    ...
    .subscribe(data => {
      ...
      this.ShowConsultant = JSON.parse(JSON.stringify(this.permission))["Master"]["Consultant Master"]["inst"] == "Y";
      this.ShowrConsultant = JSON.parse(JSON.stringify(this.permission))["Master"]["Referral Master"]["inst"] == "Y";
      this.ShowDepartment = JSON.parse(JSON.stringify(this.permission))["Master"]["Department Master"]["inst"] == "Y";
      this.Showpayment = JSON.parse(JSON.stringify(this.permission))["Master"]["Payment Mode"]["inst"] == "Y";
      this.ShowOutsideLab = JSON.parse(JSON.stringify(this.permission))["Master"]["OutsideLab Master"]["inst"] == "Y";
      this.ShowCity = JSON.parse(JSON.stringify(this.permission))["Master"]["City Master"]["inst"] == "Y";
      this.ShowCharges = JSON.parse(JSON.stringify(this.permission))["Master"]["Charges Master"]["inst"] == "Y";
      this.ShowPanel = JSON.parse(JSON.stringify(this.permission))["Master"]["Panel Master"]["inst"] == "Y";
      this.Showshift = JSON.parse(JSON.stringify(this.permission))["Master"]["Shift Master"]["inst"] == "Y";
      this.Showtestrate = JSON.parse(JSON.stringify(this.permission))["Master"]["Test Rate Change"]["inst"] == "Y";
      this.Showward = JSON.parse(JSON.stringify(this.permission))["Master"]["Ward Master"]["inst"] == "Y";
