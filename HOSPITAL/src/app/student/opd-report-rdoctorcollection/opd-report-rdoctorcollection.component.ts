...
@Component({
  selector: 'app-opd-report-rdoctorcollection',
  templateUrl: './opd-report-rdoctorcollection.component.html',
  styleUrls: ['./opd-report-rdoctorcollection.component.css']
})
export class OPDReportRdoctorcollectionComponent implements OnInit {
  declare OPD : OPD[];
  ...
  ngOnInit(): void {
    ...
    this._studentservice.gettableopddaycollectionrdoctor(routerParams["vrdt1"],routerParams["vrdt2"],routerParams["doctor"])
    .subscribe((data:OPD[]) => {
    this.OPD= data;
