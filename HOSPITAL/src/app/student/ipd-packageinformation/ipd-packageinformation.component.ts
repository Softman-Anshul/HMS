...
@Component({
  selector: 'app-ipd-packageinformation',
  templateUrl: './ipd-packageinformation.component.html',
  styleUrls: ['./ipd-packageinformation.component.css']
})
export class IpdPackageinformationComponent {
  test = new Test();
  OPD = new OPD();
  uname = '';
  dcmntNo = 0;
