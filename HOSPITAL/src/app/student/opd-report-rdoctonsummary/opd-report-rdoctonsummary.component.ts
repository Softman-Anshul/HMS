...
@Component({
  selector: 'app-opd-report-rdoctonsummary',
  templateUrl: './opd-report-rdoctonsummary.component.html',
  styleUrls: ['./opd-report-rdoctonsummary.component.css']
})
export class OPDReportRdoctonsummaryComponent implements OnInit {
  declare OPD : OPD[];
  uname = '';
