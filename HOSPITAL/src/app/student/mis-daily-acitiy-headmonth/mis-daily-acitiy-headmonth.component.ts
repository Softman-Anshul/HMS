...
@Component({
  selector: 'app-mis-daily-acitiy-headmonth',
  templateUrl: './mis-daily-acitiy-headmonth.component.html',
  styleUrls: ['./mis-daily-acitiy-headmonth.component.css']
})
export class MisDailyAcitiyHeadmonthComponent implements OnInit {
  uname = '';
  ...
  ngOnInit(): void {
    ...
    this._studentservice.misheadsmonthacticity(routerParams["vrdt1"], routerParams["vrdt2"], routerParams["doc1"], routerParams["doc5"])
