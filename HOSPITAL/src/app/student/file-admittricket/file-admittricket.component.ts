...
@Component({
  selector: 'app-file-admittricket',
  templateUrl: './file-admittricket.component.html',
  styleUrls: ['./file-admittricket.component.css']
})
export class FILEAdmittricketComponent implements OnInit {
  test = new Test();
  OPD = new OPD();
  uname = '';
  dcmntNo = 0;
