...
@Component({
  selector: 'app-disccertificate-lama',
  templateUrl: './disccertificate-lama.component.html',
  styleUrls: ['./disccertificate-lama.component.css']
})
export class DisccertificateLAMAComponent implements OnInit {
  test = new Test();
  OPD = new OPD();
  uname = '';
  dcmntNo=0;
