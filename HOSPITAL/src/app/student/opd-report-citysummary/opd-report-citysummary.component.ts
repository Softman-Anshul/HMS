...
@Component({
  selector: 'app-opd-report-citysummary',
  templateUrl: './opd-report-citysummary.component.html',
  styleUrls: ['./opd-report-citysummary.component.css']
})
export class OPDReportCitysummarynComponent implements OnInit {
  declare OPD : OPD[];
  uname = '';
  ...
  ngOnInit(): void {
    ...
    this._studentservice.gettableopdareasummary(routerParams["vrdt1"],routerParams["vrdt2"])
    .subscribe((data:OPD[]) => {
    this.OPD= data;
