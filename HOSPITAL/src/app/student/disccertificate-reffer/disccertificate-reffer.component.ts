...
@Component({
  selector: 'app-disccertificate-reffer',
  templateUrl: './disccertificate-reffer.component.html',
  styleUrls: ['./disccertificate-reffer.component.css']
})
export class DisccertificateREFFERComponent implements OnInit {
  test = new Test();
  OPD = new OPD();
  uname = '';
  dcmntNo=0;
