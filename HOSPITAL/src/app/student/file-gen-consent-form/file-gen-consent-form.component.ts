...
@Component({
  selector: 'app-file-gen-consent-form',
  templateUrl: './file-gen-consent-form.component.html',
  styleUrls: ['./file-gen-consent-form.component.css']
})
export class FILEGenConsentFormComponent implements OnInit {
  test = new Test();
  OPD = new OPD();
  uname = '';
  dcmntNo = 0;
