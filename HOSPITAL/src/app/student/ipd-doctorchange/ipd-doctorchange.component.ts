...
@Component({
  selector: 'app-ipd-doctorchange',
  templateUrl: './ipd-doctorchange.component.html',
  styleUrls: ['./ipd-doctorchange.component.css']
})
export class IpdDoctorchangeComponent implements OnInit {
  OPD = new OPD();
  uname = '';
 ...
 constructor(private _studentservice:StudentsService,
    ...
    public dialogRef: MatDialogRef<IpdDoctorchangeComponent>,
 ...
 onsave(){
 this._studentservice.ipddoctorchange(this.OPD)
 .subscribe(data => {
