...
export class MasterReportComponent implements OnInit {
  ...
  declare City : Students[];
  declare User : Students[];
  ...
  constructor(private _studentservice:StudentsService,
    ...
    ngOnInit(): void {
      ...
      //call Consultant
    this._studentservice.gettableconsultantdata()
    .subscribe((data:Students[]) => {
    this.Students = data;
    });
      //call City
      this._studentservice.gettablecitydata()
      .subscribe((data:Students[]) => {
      this.City = data;
      });
      //call User
      this._studentservice.gettableunamedata()
      .subscribe((data:Students[]) => {
      this.User = data;
      });
       //call labname
