...
@Component({
  selector: 'app-report-outsourcereport',
  templateUrl: './report-outsourcereport.component.html',
  styleUrls: ['./report-outsourcereport.component.css']
})
export class ReportOutsourcereportComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.pcity = routerParams["Outsource"];
    this._studentservice.gettabledaycollectionlab(routerParams["vrdt1"],routerParams["vrdt2"],routerParams["Outsource"])
